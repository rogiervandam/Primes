...
{
    logBegins6(sieve->bitstorage, time_markFactors_wheelstorage_small_repeat_pair_vector, "MarkFactorsWheelStorageSmallRepeatPairVector: setting factors step %3ju using markFactors_wheelstorage_small_repeat_pair_vector %s in %ju factor range (%ju-%ju) (%ju occurances; %ju repeats)", (uintmax_t)step, STR(suffix), (uintmax_t)safe_diff(range_stop,range_start),(uintmax_t)range_start,(uintmax_t)range_stop, (uintmax_t)((safe_diff(range_stop,range_start))/(uintmax_t)step), (uintmax_t)(((uintmax_t)safe_diff(range_stop,range_start))/(uintmax_t)(bitcount_type(bitbucket_t)*step)));
    ...
    logEnds6(sieve->bitstorage, time_markFactors_wheelstorage_small_repeat_pair_vector, "MarkFactorsWheelStorageSmallRepeatPairVector: finished setting factors\n");
}
