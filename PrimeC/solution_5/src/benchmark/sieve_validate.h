...
static int checkSieveWithBenchmarkSettings(sieve_t* (*sieveFunction)(const counter_t, const storage_type), benchmark_settings_t benchmark_settings) 
{
    ...
    sieve_t* sieve_check = sieveFunction(factor_max, benchmark_settings.storage);
...
checkSieveAlgorithm(sieve_t* (*sieveFunction)(const counter_t, const storage_type), benchmark_settings_t benchmark_settings)
{
...
static int __attribute__((cold)) 
checkSieveAlgorithmAll(sieve_t* (*sieveFunction)(const counter_t, const storage_type), benchmark_settings_t benchmark_settings)
{
...
showResult(sieve_t* (*sieveFunction)(const counter_t, const storage_type), benchmark_settings_t benchmark_settings)
{
...
handleCheckOption(int check, sieve_t* (*sieveFunction)(const counter_t, const storage_type), benchmark_settings_t benchmark_settings) {
