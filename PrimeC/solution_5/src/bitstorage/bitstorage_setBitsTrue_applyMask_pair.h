...
function(applyMask_index_pair,suffix)(void* restrict bitstorage, const counter_t index_vector, const counter_t step, const counter_t range_stop, const bitbucket_t mask1, const bitbucket_t mask2) 
{
