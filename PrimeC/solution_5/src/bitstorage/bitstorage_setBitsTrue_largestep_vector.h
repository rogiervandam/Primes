...
{
    startAnalysisTrace6(time_setBitsTrue_largestep_bitbucket, "SetBitsTrueLargestepVector: setting bits step %3ju using largestep_bitbucket%s in %ju bit range (%ju-%ju) (%ju occurances; %ju stamps)", (uintmax_t)step, STR(suffix), (uintmax_t)safe_diff(range_stop,range_start),(uintmax_t)range_start,(uintmax_t)range_stop, (uintmax_t)((safe_diff(range_stop,range_start))/(uintmax_t)step), (uintmax_t)(((uintmax_t)safe_diff(range_stop,range_start))/(uintmax_t)(bitcount_type(bitbucket_t)*step)));
    ...
    endAnalysisTrace6(time_setBitsTrue_largestep_bitbucket,"\n");
}
