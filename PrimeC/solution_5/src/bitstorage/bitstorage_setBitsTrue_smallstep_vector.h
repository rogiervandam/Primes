...
static inline void __attribute__((always_inline)) create_mask_vector_smallstep(bitword_t* restrict bitstorage, const counter_t range_start, const counter_t step, const counter_t range_stop)
{
    ...
    bitvector_t mask_vector = VECTOR_BASE(pattern) << (VECTOR_BASE(shift) + (VECTOR_BASE(pattern_wordshift) * VECTOR_BYTEINDEX)) % VECTOR_BASE(step);
...
static inline void __attribute__((always_inline)) create_mask_vector_smallstep_rotate_pair(bitword_t* restrict bitstorage, const counter_t range_start, const counter_t step, const counter_t range_stop)
{
    ...
    for (; current_vector < vector_max; current_vector += 2) {
        bitvector_t mask_vector2 = (mask_vector << pattern_vectorshift_vector) | (mask_vector >> (step_shift_vector - pattern_vectorshift_vector)); 
        applyMask_vector_pair(bitstorage_vector, step, range_stop, mask_vector, mask_vector2, current_vector);
...
//     register const bitvector_t mask_vector_base = VECTOR_BASE(pattern);
...
//         register const bitvector_t mask_vector1 = mask_vector_base << ((shift_vector + (index_vector * pattern_vectorshift_vector) ) % step_vector);
//         applyMask_vector(bitstorage_vector, step, range_stop, mask_vector1, range_startvector + index_vector);
//         register const bitvector_t mask_vector2 = mask_vector_base << ((shift_vector + ((index_vector+1) * pattern_vectorshift_vector) ) % step_vector);
//         applyMask_vector(bitstorage_vector, step, range_stop, mask_vector2, range_startvector + index_vector+1);
//         register const bitvector_t mask_vector3 = mask_vector_base << ((shift_vector + ((index_vector+2) * pattern_vectorshift_vector) ) % step_vector);
//         applyMask_vector(bitstorage_vector, step, range_stop, mask_vector3, range_startvector + index_vector+2);
//         register const bitvector_t mask_vector4 = mask_vector_base << ((shift_vector + ((index_vector+3) * pattern_vectorshift_vector) ) % step_vector);
//         applyMask_vector(bitstorage_vector, step, range_stop, mask_vector4, range_startvector + index_vector+3);
//     }

//     for (; index_vector <= index_vector_max; index_vector++) {
//         const bitvector_t mask_vector = mask_vector_base << ((shift_vector + ((VECTOR_BASE(index_vector)) * pattern_vectorshift_vector) ) % step_vector);
//         applyMask_vector(bitstorage_vector, step, range_stop, mask_vector, range_startvector + index_vector);
//     }
//     timer_laptime(time_create_mask_vector_smallstep); 
// }
...
//     const bitvector_t mask_vector_base = VECTOR_BASE(pattern);
...
//         const bitvector_t mask_vector = mask_vector_base << ((shift_base_vector + (index_vector * pattern_vectorshift_vector) + pattern_wordshift_vector_plus) % step_vector);
//         applyMask_vector(bitstorage_vector, step, range_stop, mask_vector, range_startvector + index_vector);
//     }
// }
