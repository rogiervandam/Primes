...
{
    if (1==0) {}
    // else if (step  <  16)  setBitsTrue_smallstep_rotate_pair_uint16v8_unroll8(bitstorage, range_start, range_stop, step);
...
setBitsTrue_v256(void* restrict bitstorage, const counter_t range_start, const counter_t range_stop, const counter_t step) 
{
    if (step < 64) {
        if (1==0) {}
        // else if (step  <  16)  setBitsTrue_smallstep_rotate_pair_uint16v16_unroll8(bitstorage, range_start, range_stop, step);
...
setBitsTrue_v512(void* restrict bitstorage, const counter_t range_start, const counter_t range_stop, const counter_t step) 
{
    ...
    if (1==0) {}
    // else if (step  <  16)  setBitsTrue_smallstep_rotate_pair_uint16v32_unroll4(bitstorage, range_start, range_stop, step);
