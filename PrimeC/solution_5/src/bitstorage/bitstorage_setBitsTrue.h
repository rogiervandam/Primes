...
setBitsTrue(void* restrict bitstorage, const counter_t range_start, const counter_t range_stop, const counter_t step) 
{
    ...
    // else 
    logBegin6(time_setBitsTrue, "SetBitsTrue: setting bits step %3ju in %ju bit range (%ju-%ju) with %ju bits to set", (uintmax_t)step, (uintmax_t)safe_diff(range_stop,range_start),(uintmax_t)range_start,(uintmax_t)range_stop, (uintmax_t)((safe_diff(range_stop,range_start))/(uintmax_t)step));
