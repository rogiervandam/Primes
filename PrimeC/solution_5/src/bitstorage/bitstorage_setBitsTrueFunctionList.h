...
static SetBitsTrueMethod setBitsTrueMethods[] = {
    ...
    // {1, "setBitsTrue_smallstep_rotate_pairv3_uint64v8", setBitsTrue_smallstep_rotate_pairv3_uint64v8, 0, 63, 1},
    // {1, "setBitsTrue_smallstep_rotate_pairv3_uint64v4", setBitsTrue_smallstep_rotate_pairv3_uint64v4, 0, 63, 1},
    ...
    // {1, "setBitsTrue_smallstep_rotate_pairv2_uint64v8", setBitsTrue_smallstep_rotate_pairv2_uint64v8, 0, 63, 1},
    // {1, "setBitsTrue_smallstep_rotate_pairv2_uint64v4", setBitsTrue_smallstep_rotate_pairv2_uint64v4, 0, 63, 1},
    // {1, "setBitsTrue_smallstep_rotate_pairv3_uint64v8", setBitsTrue_smallstep_rotate_pairv3_uint64v8, 0, 63, 1},
    ...
    // {6, "setBitsTrue_largestep_vector_uint64v4_unroll8", setBitsTrue_largestep_vector_uint64v4_unroll8, 65, 255, 1},
    ...
    // {9, "setBitsTrue_largestep_vector_uint16v8_unroll8", setBitsTrue_largestep_vector_uint16v8_unroll8, 17, 127, 0},
    // {11, "setBitsTrue_largestep_norepeat_uint8_unroll4", setBitsTrue_largestep_norepeat_uint8_unroll4, 0, INT32_MAX, 1},
    // {11, "setBitsTrue_largestep_norepeat_uint8_unroll4", setBitsTrue_largestep_norepeat_uint8_unroll4, 0, INT32_MAX, 1},
    {11, "setBitsTrue_largestep_norepeat_uint8_unroll8", setBitsTrue_largestep_norepeat_uint8_unroll8, 0, INT32_MAX, 1},
    {12, "setBitsTrue_largestep_repeat_uint8_unroll4", setBitsTrue_largestep_repeat_uint8_unroll4, 0, INT32_MAX, 1},
    {12, "setBitsTrue_largestep_repeat_uint8_unroll8", setBitsTrue_largestep_repeat_uint8_unroll8, 0, INT32_MAX, 1},
    {15, "setBitsTrue_largestep_repeat_uint64_unroll4", setBitsTrue_largestep_repeat_uint64_unroll4, 0, INT32_MAX, 1},
    {17, "setBitsTrue_largestep_repeat_uint16_unroll4", setBitsTrue_largestep_repeat_uint16_unroll4, 0, INT32_MAX, 1},
