...
{ 
    logBegin7(time_setBitsTrue_largestep_repeat, "SetBitsTrueLargestepRepeat: setting bits step %3ju using largestep%s in %ju bit range (%ju-%ju) (%ju repeating occurrences)", (uintmax_t)step, STR(suffix), (uintmax_t)range_stop-(uintmax_t)range_start, (uintmax_t)range_start, (uintmax_t)range_stop, (uintmax_t)(((uintmax_t)range_stop-(uintmax_t)range_start)/(uintmax_t)(bitcount_type(bitbucket_t)*step)));
    ...
    logEnd7(time_setBitsTrue_largestep_repeat,"\n");
}
...
{
    logBegin7(time_setBitsTrue_largestep_norepeat, "SetBitsTrueLargestepNoRepeat: setting bits step %3ju using largestep%s in %ju bit range (%ju-%ju) (%ju unique occurances)", (uintmax_t)step, STR(suffix), (uintmax_t)safe_diff(range_stop,range_start),(uintmax_t)range_start,(uintmax_t)range_stop, (uintmax_t)(((uintmax_t)safe_diff(range_stop,range_start))/(uintmax_t)step));
    ...
    logEnd7(time_setBitsTrue_largestep_norepeat,"\n");
}
