...
{
    logStart7(sieve->bitstorage, time_markFactors_wheelstorage_small_repeat_pair, "Setting factors for prime %ju with step %ju using 'repeating pairs' of %s in %ju number range (%ju-%ju)", 
    ...
    counter_t pending_bucket = 0, current_bucket = 0; // initialize current_bucket to 0 always triggers pending mask, but meybe cheaper than calculating the first bucket beforehand
