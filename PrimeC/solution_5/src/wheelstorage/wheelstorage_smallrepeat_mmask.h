...
function(markFactors_wheelstorage_small_repeat_mmask,suffix)(void* restrict bitstorage, counter_t start_number, const counter_t stop_number, const counter_t step)
{
