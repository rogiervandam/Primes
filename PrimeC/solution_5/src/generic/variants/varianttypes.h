...
// #undef  variant_base
// #define variant_base        CONCAT(uint, variant_bits) // this is set to the base type of the bitbucket (e.g. uint64_t for uint64 variants) and can be used in the code to define constants of the correct type, e.g. BITBUCKET0
// #undef  variant_base_type_t 
// #define variant_base_type_t CONCAT(variant_base, _t) // this is set to the base type of the bitbucket (e.g. uint64_t for uint64 variants) and can be used in the code to define constants of the correct type, e.g. BITBUCKET0
// #undef  variant
// #define variant CONCAT(variant_base, CONCAT("v",variant_elements)) // this is the name of the variant (e.g. uint64v4) and can be used in the code to define variables of the correct type
