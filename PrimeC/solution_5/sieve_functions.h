...
static inline counter_t __attribute__((always_inline)) sieve_block_stripe_new(bitword_t* restrict bitstorage, const counter_t block_start, const counter_t block_stop, const counter_t prime_start, const counter_t prime_max)
{
    ...
    verbose4( printf("Prime endloop 1: %ju\n", (uintmax_t)prime); )
    ...
    verbose4( printf("Prime endloop 1b: %ju\n", (uintmax_t)prime); )
    ...
    verbose4( printf("Prime endloop 2: %ju\n", (uintmax_t)prime); )
    ...
    verbose4( printf("Prime endloop 3: %ju\n", (uintmax_t)prime); )
    ...
    verbose4( printf("Prime endloop 4: %ju\n", (uintmax_t)prime); )
    ...
    verbose4( printf("Prime endloop final: %ju\n", (uintmax_t)prime); )
