...
3. `docs/AI_MAINTENANCE.md`

Working rules:

1. Prefer small, behavior-preserving edits in high-risk files (`Visualizer.jsx`,
	`SieveRenderer.js`).
...
5. After docs-affecting changes, update the relevant docs in `docs/` in the same
	patch.